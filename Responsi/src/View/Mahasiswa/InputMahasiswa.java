...
public class InputMahasiswa extends JFrame {
    ...
    JPasswordField inputPassword = new JPasswordField(); // Menggunakan JPasswordField untuk input password
    ...
    public InputMahasiswa() {
        ...
        setLayout(null);
        setSize(480, 540); // Diperbesar untuk menampung input tambahan
    ...
    public String getInputPassword() {
        return new String(inputPassword.getText());
    }
